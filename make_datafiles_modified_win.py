...
if __name__ == '__main__':
  ...
  write_to_bin('C:/HONOURS/unified-summarization/data/gigawordProcessed/test', os.path.join(finished_files_dir, "test.bin"))
  write_to_bin('C:/HONOURS/unified-summarization/data/gigawordProcessed/val', os.path.join(finished_files_dir, "val.bin"))
  write_to_bin('C:/HONOURS/unified-summarization/data/gigawordProcessed/train', os.path.join(finished_files_dir, "train.bin"), makevocab=True)
