...
all_train_urls = "url_lists/train.txt"
all_val_urls = "url_lists/val.txt"
all_test_urls = "url_lists/test.txt"
...
def write_to_tar(url_file, out_file, makevocab=False):
    ...
    with tarfile.open(out_file, 'w') as writer:
        for idx, s in enumerate(story_fnames):
            ...
            if os.path.isfile(os.path.join(cnn_stories_dir + '/test', s)):
                story_file = os.path.join(cnn_stories_dir + '/test', s)
            elif os.path.isfile(os.path.join(cnn_stories_dir + '/val', s)):
                story_file = os.path.join(cnn_stories_dir + '/val', s)
            elif os.path.isfile(os.path.join(cnn_stories_dir + '/train', s)):
                story_file = os.path.join(cnn_stories_dir + '/train', s)
            else:
                print 'Couldnt find ' + str(os.path.join(cnn_tokenized_stories_dir + '/test', s))
